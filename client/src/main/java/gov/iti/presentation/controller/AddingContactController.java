...
public class AddingContactController implements Initializable {
    ...
    public void sendInvitation() {
        System.out.println("send invitation to server");
        System.out.println(contact); //SceneManager.currentUser.getPhoneNumber()
        invitationStatus=AddingContactService.getAddingNewContactService().addNewContact("01012345678",contact);
        showInvitationStatus();
        //contactLabels.get(1).setStyle(contactErrorStyle);
    }
